		...
		<div class="d-flex flex-column">
			...
			<nav id="navbar" class="nav-menu navbar">
				<ul>
					...
					<li><a href="about.php" class="nav-link scrollto active"><i class="bx bx-bus-school"></i> <span>About</span></a></li>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2>About</h2>
          <p>I'm Nathan Chavez I am a student at UTSA studying Computer Science.</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>17 August 2000</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>School:</strong> <span>University of Texas San Antonio</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+123 456 7890</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>San Antonio, TX</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
