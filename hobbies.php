		...
		<div class="d-flex flex-column">
			...
			<nav id="navbar" class="nav-menu navbar">
				<ul>
					...
					<li><a href="hobbies.php" class="nav-link scrollto active"><i class="bx bx-hard-hat"></i> <span>Hobbies</span></a></li>
		...
		<div class="row">
			<div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
			   <div class="row">
				  <div class="col-lg-6">
					<ul>
					  	<li><i class="bi bi-chevron-right"></i><span> Video Games</span></li>
						<li><i class="bi bi-chevron-right"></i><span> Board Games</span></li>
						<li><i class="bi bi-chevron-right"></i><span> Trying to Play Guitar</span></li>
						<li><i class="bi bi-chevron-right"></i><span> Building Things</span></li>
						<li><i class="bi bi-chevron-right"></i><span> Working On Cars</span></li>
						<li><i class="bi bi-chevron-right"></i><span> Cooking</span></li>
					</ul>
				  </div>
				</div>
			</div>
